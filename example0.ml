let () =
  let app =
    Gtk.Application_._new "org.gtk.example" Gio.ApplicationFlags.flags_none
  in
  ignore
  @@ Gio.Application_.signal_connect_activate app (fun () ->
         ...
         let pack = Gtk.Box_._new Gtk.Enum.Vertical 20 in
         ...
         let _ =
           Gtk.Button_.signal_connect_clicked button (fun () ->
               print_endline "CLICKED!")
         in
         Gtk.Button_.set_label button "Hello";
         Gtk.Widget_.set_hexpand button true;

         let button2 = Gtk.Button_._new () in
         let _ =
           Gtk.Button_.signal_connect_clicked button2 (fun () ->
               print_endline "CLICKED!")
         in
         Gtk.Button_.set_label button2 "Goodbye";
         Gtk.Widget_.set_hexpand button2 true;

         Gtk.Box_.append pack button;
         Gtk.Box_.append pack button2;
         Gtk.Window_.set_child window pack;
         let _ =
           Gtk.Window_.signal_connect_close_request window (fun () -> exit 0)
         in
